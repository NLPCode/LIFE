...
model_path_prefix=../checkpoints_corrector/t5-base/seed42_lr4e-05_2-retrieved-evidence_
...
model_path=${model_path_prefix}${mask1}_leven${leven_threshold}_cls${cls_threshold}_${min_prob}_${mask2}_beam_1/${NUM_DATA_INSTANCE}data_seed42_lr4e-05_2-retrieved-evidence
